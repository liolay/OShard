 ...
 */
@Slf4j
public class ResultSetWrapper extends WrapperImpl implements ResultSet, InvocationHandler {
    private List<ResultSet> rss;
    private ResultSet rs;

    public ResultSetWrapper(List<ResultSet> resultSets) {
        List<ResultSet> rsList = Lists.newArrayList(resultSets);
        this.rs = rsList.remove(0);
        this.rss = rsList;
    }
    ...
    @Override
    public long getLong(int colcumnIndex) throws SQLException {
        return 0;
    }
